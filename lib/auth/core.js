 ...
 * 
 * @param {string} code
 * @returns {{access_token: string, token_type: string, expires_in: number, refresh_token: string, scope: string} | null}
 */
...
async function register(code) {
    ...
    return await newUser(userResult.id, oauthData.access_token, oauthData.refresh_token, oauthData.expires_in)
}

module.exports = { exchangeCode, register, refreshToken }