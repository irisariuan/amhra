...
function getAudioPlayer(client, interaction, opts = {createPlayer: true, createOpts: {}, fail: false}) {
    ...
    if (!player && opts.createPlayer) {
        ...
        return player;
    } else if (!player && !opts.createPlayer) {
    	return opts.fail;
    }
    return player;
}
...
module.exports = { getAudioPlayer, createResource, record, joinVoice, ensureConnection, getConnection, isPlaylist, isVideo, songToStr }
