...
function destoryAudioPlayer(client, interaction) {
    if (client.player.hasOwnProperty(interaction.guild.id)) {
        // reset player to the init status
        client.player[interaction.guild.id].nowPlaying = null
        client.player[interaction.guild.id].queue = []
        client.player[interaction.guild.id].isPlaying = false
        client.player[interaction.guild.id].volume = 1
