...
class CustomClient extends Client {
	...
	/**
	 * @type {(guildId: string) => {token: string, guilds: string[], level: number} | null}
	 */
	#newToken
	...
	constructor(clientOpt) {
		...
		/**
		 * 
		 * @type {(guildId: string) => {token: string, guilds: string[], level: number}}
		 */
		this.#newToken = null
	}
	...
	/**
	 * 
	 * @param {Map<string, {guilds: string[], level: number}>} levelMap 
	 * @param {(guildId: string) => {token: string, guilds: string[], level: number}} newToken 
	 */
	initDashboard(levelMap, newToken) {
	...
	login(token) {
		if (!this.#newToken || !this.levelMap) {
